...
<p align="center">
  <sub>trc-20 · energy · usdt</sub>
</p>

<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>TronWallet</code> &nbsp;·&nbsp; <code>tronwallet</code>
</p>
...
TRC-20 focused wallet — energy estimates, USDT sends, multi-account list.

OTC desks search tron-wallet when they outgrow browser extensions.
...
```bash
dotnet restore tron-wallet.slnx
dotnet build tron-wallet.slnx -c Release
dotnet test tron-wallet.slnx -c Release
```
